...
public class MainActivity extends AppCompatActivity {
    ...
    public native String getVideoDuration(String filePath);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        @SuppressLint("SdCardPath") String filePath = "/sdcard/1.mp4";
        String duration = getVideoDuration(filePath);
        Log.d("MainActivity", "Video duration: " + duration);
        ...
        mHandler = new Handler(Looper.getMainLooper()) {
            public void handleMessage(@NonNull Message msg) {
                ...
                if (msg.what == 1) {
                    ...
                    Log.d("MainActivity", "Progress updated: " + progress);
                }
            }
        };
    ...
    private void startProgressThread() {
        progressThread = new Thread(() -> {
            ...
            while (true) {
                ...
                Log.d("MainActivity", "Current progress: " + progress);
                setSeekBar(progress);
                try {
                    Thread.sleep(500);
